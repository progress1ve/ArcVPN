...
def test_cleanup_candidates_excludes_paid_active_recent_and_admin_users():
    ...
    conn.executescript("""
        CREATE TABLE users (
            ...
            created_at TEXT, is_active INTEGER, used_trial INTEGER
        );
        CREATE TABLE payments (user_id INTEGER, status TEXT, payment_type TEXT);
        CREATE TABLE vpn_keys (user_id INTEGER, expires_at TEXT);
        INSERT INTO users VALUES (1, 101, 'eligible', '2024-01-01', 0, 1);
        INSERT INTO users VALUES (2, 102, 'paid', '2024-01-01', 0, 0);
        INSERT INTO users VALUES (3, 103, 'active_key', '2024-01-01', 0, 0);
        INSERT INTO users VALUES (4, 104, 'recent', '2026-08-24', 0, 0);
        INSERT INTO users VALUES (5, 105, 'admin', '2024-01-01', 0, 0);
