...
const FALLBACK_NAME = import.meta.env.VITE_APP_NAME || 'ArcVPN';
const FALLBACK_LOGO = import.meta.env.VITE_APP_LOGO || 'A';
...
export function AppHeader({
  ...
  const navItems = location.pathname.startsWith('/admin') ? [] : customerNavItems;
