...
<h2>2. Подписка, оплата и возвраты</h2><p>Срок, цена и состав тарифа показываются до оплаты. Доступ предоставляется сразу на оплаченный период. После начала предоставления цифрового доступа ArcVPN не делает добровольный возврат за неиспользованный остаток срока, изменение решения пользователя, несовместимость его устройства или ограничения сторонних сетей. Это правило не отменяет возврат при ошибочном списании, непредоставлении оплаченного доступа и иные права, которые нельзя исключить по закону.</p>
...
<h2>4. Доступность и ответственность</h2><p>ArcVPN предоставляется «как есть»: мы поддерживаем инфраструктуру и устраняем неисправности, но не гарантируем непрерывную доступность каждого сервера, протокола, оператора связи или стороннего сайта. В пределах, разрешённых законом, оператор не отвечает за косвенные убытки, действия пользователя, блокировки и сбои внешних сетей и сервисов. Наша ответственность за подтверждённое нарушение ограничивается стоимостью спорного оплаченного периода, кроме случаев, когда закон прямо запрещает такое ограничение.</p>
