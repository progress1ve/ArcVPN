...
LEGAL_LAST_UPDATED = "10 сентября 2026"
...
def _normalize_output_format(raw_format: str, client_family: str) -> str:
    ...
    if not output_format:
        # Happ and INCY understand our JSON array of full Xray profiles. The first
        ...
        if client_family in {"happ", "incy", "generic"}:
            return "json"
...
<tr><td style="padding:34px 38px 16px;font-size:23px;font-weight:800;letter-spacing:-.02em">ArcVPN</td></tr>
...
CUSTOM_LTE_CHOICES_GB = frozenset({0, 15, 30, 45, 75, 115, 175, 225})
