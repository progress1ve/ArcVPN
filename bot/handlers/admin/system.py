...
async def edit_text_start(callback: CallbackQuery, state: FSMContext):
    ...
    help_texts = {
        ...
        'payment_select_text': (
            ...
            "Этот текст показывается перед информацией о тарифе.\n\n"
            "После вашего текста автоматически добавится блок:\n"
            "💳 <b>Оплата подписки</b>\n\n"
            ...
            "Если текст не задан, показывается только блок с информацией о тарифе."
        ),
    }
