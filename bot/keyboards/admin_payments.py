...
def payments_menu_kb(stars_enabled: bool, crypto_enabled: bool, cards_enabled: bool, qr_enabled: bool=False, monthly_reset_enabled: bool=False, demo_enabled: bool=False) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text='Группы тарифов', callback_data='admin_groups', icon_custom_emoji_id='5884479287171485878'))
    builder.row(InlineKeyboardButton(text='Тарифы', callback_data='admin_tariffs', icon_custom_emoji_id='5870528606328852614'))
    builder.row(InlineKeyboardButton(text='Пробная подписка', callback_data='admin_trial', icon_custom_emoji_id='6032644646587338669'))
...
def crypto_setup_kb(step: int) -> InlineKeyboardMarkup:
    ...
    buttons.append(InlineKeyboardButton(text='Отмена', callback_data='admin_payments', icon_custom_emoji_id='5870657884844462243'))
    builder.row(*buttons)
    return builder.as_markup()
...
def crypto_setup_confirm_kb() -> InlineKeyboardMarkup:
    ...
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text='Сохранить и включить', callback_data='admin_crypto_setup_save', icon_custom_emoji_id='5870633910337015697'))
    builder.row(InlineKeyboardButton(text='◁ Назад', callback_data='admin_crypto_setup_back'), InlineKeyboardButton(text='Отмена', callback_data='admin_payments', icon_custom_emoji_id='5870657884844462243'))
    return builder.as_markup()
...
def cards_management_kb(is_enabled: bool) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text='Изменить Provider Token', callback_data='admin_cards_mgmt_edit_token', icon_custom_emoji_id='5769289093221454192'))
...
def edit_crypto_kb(current_param: int, total_params: int) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text='Готово', callback_data='admin_crypto_edit_done', icon_custom_emoji_id='5870633910337015697'))
    return builder.as_markup()
...
def crypto_management_kb(is_enabled: bool, integration_mode: str) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text='Изменить ссылку на товар', callback_data='admin_crypto_mgmt_edit_url', icon_custom_emoji_id='5769289093221454192'))
    builder.row(InlineKeyboardButton(text='Изменить секретный ключ', callback_data='admin_crypto_mgmt_edit_secret', icon_custom_emoji_id='6037249452824072506'))
    builder.row(back_button('admin_payments'), home_button())
    return builder.as_markup()
