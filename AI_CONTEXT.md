...
- 2026-08-11 wCloud заменил проблемную Германию на вторую Францию: control `fr2.sfxu.ru:20085`, TCP Reality `:20086`, Hysteria2 `:20087`, SID `ba5b0807589028e6`, public key `IRmahen2BbN-2-_exw4TNoeJBGAF0bvVSobxdBQ_Bn0`. Целевой каталог: Франция `#1–#4`, Финляндия `#1–#3`, старая Германия `(резерв)`, LTE. Новая Франция публикуется только при `REMNAWAVE_FRANCE2_ENABLED=True` после успешного подключения node к панели.
