...
- Commit `3b9eec1` adds bounded inertial scrolling for discrete mouse-wheel input. High-resolution trackpad input stays native, and `prefers-reduced-motion` bypasses the animation.
- Commits `89b1595`, `d6c9613`, `c800338`, `5dfb6df`, `4571145` and `3b9eec1` are deployed on the Poland control plane. Browser QA passed at 360x800, 390x844, 768x1024, 1280x900 and 1600x900 with no overflow; public landing, app, Hero media and cabinet images return HTTP 200.
