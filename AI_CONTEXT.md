...
- Legal consent version `2026-09-10` is canonical across the public page, WebApp and Telegram gate. Daily backup maintenance remains local-only: retained DB copies are created and expired copies cleaned, with no Telegram archive delivery to admins.
