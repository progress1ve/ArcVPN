...
export const fetchAdminNodeMetrics = (host, range = '1h') => get(`/api/admin/nodes/metrics?host=${encodeURIComponent(host)}&range=${encodeURIComponent(range)}`)
...
export const createAdminExpense = (expense) => post('/api/admin/expenses', expense)
