...
<style>
  ...
  /* Admin workbench — flat, dense and deliberately close to the approved reference rhythm. */
  :global(body.admin-console-open){background:#090d12}
  .console{--card:#11171f;--line:#232b35;grid-template-columns:232px minmax(0,1fr);background:#090d12}
  main{width:min(1480px,calc(100% - 48px));padding:24px 0 56px}
  .health{min-height:42px;gap:12px;padding:11px 15px;border-color:#214137;border-radius:11px;background:#101b1b}.health>i{width:7px;height:7px;box-shadow:none}.health div{gap:1px}.health div b{font-size:12px}.health span{font-size:10px}.health>strong{padding:5px 8px;border-radius:7px;background:#163027;font-size:10px}
  .periods{margin-top:12px;padding:3px;border-color:#252d37;border-radius:9px;background:#10151c}.periods button{min-height:30px;padding:0 12px;border-radius:6px;font-size:10px}.periods button.active{background:#1a2f42;color:#75bcea}
  .metrics{gap:10px;margin:10px 0 14px}.metrics article{position:relative;min-height:92px;display:grid;grid-template-columns:34px 1fr;grid-template-rows:auto 1fr auto;column-gap:10px;padding:14px;border-color:#232b35;border-radius:11px;background:#11171f!important;box-shadow:none}.metrics .metric-icon{grid-row:1/3;width:32px;height:32px;display:grid;place-items:center;border-radius:8px;font-style:normal}.metric-icon.blue{background:#172b3b;color:#68b7ea}.metric-icon.green{background:#142a24;color:#5fd19d}.metric-icon.amber{background:#302619;color:#e5ad58}.metric-icon.violet{background:#28223b;color:#a998e7}.metrics span{align-self:center;color:#8b97a6;font-size:10px}.metrics strong{grid-column:2;margin:5px 0 2px;font-size:23px}.metrics small{grid-column:2;color:#687788;font-size:9px}
  .overview-grid{gap:12px}.panel{padding:17px;border-color:#232b35;border-radius:12px;background:#11171f;box-shadow:none}.panel-head{margin-bottom:13px}.panel-head span{color:#697687;font-size:9px;letter-spacing:.08em}.panel-head h2{margin-top:4px;font-size:15px;letter-spacing:-.015em}.panel-head button{font-size:10px}.node-panel{grid-column:span 8;order:1}.queue{grid-column:span 4;order:2}.acquisition-panel{grid-column:span 7;order:3}.product-panel{grid-column:span 5;order:4}.traffic-panel{grid-column:span 6;order:5}.rating-panel{grid-column:span 6;order:6}
  .nodes{gap:0;border:1px solid #202832;border-radius:9px;background:#0d1218;overflow:hidden}.nodes article{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;min-height:48px;padding:8px 11px;border-bottom:1px solid #202832;border-radius:0;background:transparent}.nodes article:last-child{border-bottom:0}.nodes article>strong{margin:0;font-size:16px}.nodes article>small{text-align:right;font-size:8px}.node-name span{font-size:9px}.queue>button{min-height:49px;padding:7px 0}.queue button>i{width:30px;height:30px;border-radius:8px}.queue button b{font-size:11px}.queue button small{font-size:9px}.queue button>strong{min-width:25px;height:25px;font-size:10px}.source-grid,.traffic-grid{gap:7px}.source-grid article,.traffic-grid article{padding:12px;border:1px solid #202832;border-radius:9px;background:#0d1218}.source-grid b,.traffic-grid b{font-size:19px}.rating-summary{gap:7px}.rating-summary article{padding:11px;border:1px solid #202832;border-radius:9px;background:#0d1218}.rating-summary b{font-size:18px}.product-list article,.rating-responses article{padding:8px 0}
  @media(max-width:1100px){.console{grid-template-columns:68px minmax(0,1fr)}.node-panel,.queue,.acquisition-panel,.product-panel,.traffic-panel,.rating-panel{grid-column:1/-1}}
  @media(max-width:560px){.console{display:block}.console>main{width:calc(100% - 24px);padding:18px 0 calc(88px + env(safe-area-inset-bottom,0px))}.metrics{grid-template-columns:1fr 1fr}.metrics article{min-height:88px;padding:12px}.health{align-items:flex-start}.health>strong{display:none}.panel{padding:14px}.nodes{grid-template-columns:1fr}}
  @media(max-width:390px){.metrics{grid-template-columns:1fr}.metrics article{min-height:78px}}
</style>
