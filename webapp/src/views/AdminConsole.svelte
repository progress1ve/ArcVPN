...
<style>
  ...
  .records{max-width:980px;height:calc(100vh - 180px);display:flex;flex-direction:column;overflow:hidden}.record-list{min-height:0;overflow:auto;padding-right:8px}.record-list>article{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:15px 4px;border-bottom:1px solid var(--line)}.record-list>article:last-child{border-bottom:0}.records article div{display:flex;flex-direction:column;gap:4px}.records small{color:#70879b}.records article>span{padding:7px 11px;border-radius:14px;background:rgba(255,121,121,.08);color:#ff9c9c;font-size:11px;font-weight:800}.records article>span.ok{background:rgba(97,216,165,.09);color:#78e1b4}.filters{display:flex!important;flex-direction:row!important;gap:8px!important;margin-bottom:14px;overflow:auto}.filters button{white-space:nowrap;border:0;border-radius:18px;padding:10px 14px;background:#101c2a;color:#7f94a7;font-weight:700;cursor:pointer}.filters button.active{background:#9bd9ff;color:#08111d}
