  ...
  <main>
    ...
    {:else if active === 'network'}
      <section class="workspace-section">
        <div class="section-title"><div><span class="eyebrow">Инфраструктура</span><h2>Серверы ArcVPN</h2></div><button class="refresh" on:click={load}><ArcIcon name="pulse" size={18}/>Проверить</button></div>
