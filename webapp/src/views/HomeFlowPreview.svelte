...
<style>
  ...
  .telegram-login-widget { width: fit-content; min-height: 40px; max-width: 100%; display: flex; align-items: center; justify-content: center; margin: 28px auto 0; border: 0; background: transparent; transition: opacity .18s ease; }
  .telegram-login-widget.busy { opacity: .58; pointer-events: none; }
  .telegram-login-widget :global(iframe) { display: block; max-width: 100%; border-radius: 12px; }
