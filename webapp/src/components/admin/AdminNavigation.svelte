...
<style>
  .admin-sidebar{position:sticky;top:0;box-sizing:border-box;height:100vh;display:flex;flex-direction:column;padding:16px 12px;border-right:1px solid #202630;background:#0d1117;color:#eef2f6;font-family:Inter,system-ui,sans-serif}
  .brand{min-height:52px;display:flex;align-items:center;gap:11px;padding:0 10px 14px;border-bottom:1px solid #202630;color:#f5f7fa;text-decoration:none;font-size:15px;font-weight:750;letter-spacing:-.02em}.brand-icon{width:32px;height:32px;display:grid;place-items:center;border:1px solid #252d38;border-radius:10px;background:#151b23}.brand img{width:22px}.brand>span:last-child,.owner span{display:flex;flex-direction:column}.brand small,.owner small{margin-top:2px;color:#697586;font-size:9px;font-weight:600;letter-spacing:.04em;text-transform:none}
  nav{min-height:0;display:grid;align-content:start;gap:13px;margin-top:14px;overflow-y:auto;scrollbar-width:none}.nav-group{display:grid;gap:2px}.nav-group h2{margin:0 10px 4px;color:#626e7e;font-size:9px;font-weight:700;letter-spacing:.09em;text-transform:uppercase}.nav-group button{box-sizing:border-box;width:100%;min-height:38px;display:flex;align-items:center;gap:11px;padding:0 10px;border:1px solid transparent;border-radius:9px;background:transparent;color:#8d98a7;font-size:12px;font-weight:600;text-align:left;cursor:pointer;transition:background .15s,color .15s,border-color .15s}.nav-group button:hover{border-color:#242c36;background:#141a22;color:#dfe6ed}.nav-group button.active{border-color:#29445a;background:#142536;color:#72b9e8;box-shadow:none}.nav-group button:focus-visible{outline:2px solid #54a9eb;outline-offset:2px}
  .owner{min-height:42px;display:flex;align-items:center;gap:9px;margin-top:auto;padding:8px;border-top:1px solid #202630;color:#cbd3dc;font-size:11px}.owner>i{width:30px;height:30px;display:grid;place-items:center;border-radius:9px;background:#182b3b;color:#72b9e8;font-style:normal;font-weight:750}
